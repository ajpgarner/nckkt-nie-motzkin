function val_states = evaluate_weak_kkt_states(obj, ym_states)
%EVALUATE_WEAK_KKT_STATES Get actual numbers associated with solution.
% This state layout is the same for weak and essential ncKKT.
    ...
    val_states.lambda = evaluate_lambda(obj, ym_states.lambda);        
